...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->camera_open)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->camera_close)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->camera_save_image)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->camera_change_record_state)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->camera_zoom)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->gimbal_open)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->gimbal_close)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->gimbal_centering)
        return;
...
{
    if (id >= camera_cnt || !CAMERA_OPS(id)->gimbal_rotate)
        return;
